...
{
  uint8x8x2_t ret;
  asm ("ld1 {%S0.8b - %T0.8b}, %1" : "=w" (ret) : "Q"(*__a));
  return ret;
}
...
{
  uint16x4x2_t ret;
  asm ("ld1 {%S0.4h - %T0.4h}, %1" : "=w" (ret) : "Q"(*__a));
  return ret;
}
...
{
  uint32x2x2_t ret;
  asm ("ld1 {%S0.2s - %T0.2s}, %1" : "=w" (ret) : "Q"(*__a));
  return ret;
}
...
{
  uint64x1x2_t ret;
  asm ("ld1 {%S0.1d - %T0.1d}, %1" : "=w" (ret) : "Q"(*__a));
  return ret;
}
...
{
  uint8x16x2_t ret;
  asm ("ld1 {%S0.16b - %T0.16b}, %1" : "=w" (ret) : "Q"(*__a));
  return ret;
}
...
{
  uint16x8x2_t ret;
  asm ("ld1 {%S0.8h - %T0.8h}, %1" : "=w" (ret) : "Q"(*__a));
  return ret;
}
...
{
  uint32x4x2_t ret;
  asm ("ld1 {%S0.4s - %T0.4s}, %1" : "=w" (ret) : "Q"(*__a));
  return ret;
}
...
{
  uint64x2x2_t ret;
  asm ("ld1 {%S0.2d - %T0.2d}, %1" : "=w" (ret) : "Q"(*__a));
  return ret;
}
...
{
  asm ("st1 {%S1.1d - %T1.1d}, %0" : "=Q" (*__a) : "w" (val) : "memory");
}
...
{
  asm ("st1 {%S1.8b - %T1.8b}, %0" : "=Q" (*__a) : "w" (val) : "memory");
}
...
{
  asm ("st1 {%S1.4h - %T1.4h}, %0" : "=Q" (*__a) : "w" (val) : "memory");
}
...
{
  asm ("st1 {%S1.2s - %T1.2s}, %0" : "=Q" (*__a) : "w" (val) : "memory");
}
...
{
  asm ("st1 {%S1.16b - %T1.16b}, %0" : "=Q" (*__a) : "w" (val) : "memory");
}
...
{
  asm ("st1 {%S1.8h - %T1.8h}, %0" : "=Q" (*__a) : "w" (val) : "memory");
}
...
{
  asm ("st1 {%S1.4s - %T1.4s}, %0" : "=Q" (*__a) : "w" (val) : "memory");
}
...
{
  asm ("st1 {%S1.2d - %T1.2d}, %0" : "=Q" (*__a) : "w" (val) : "memory");
}
